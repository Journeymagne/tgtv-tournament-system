...
const TGTV_I18N_RU = {
  ...
  "leaderboard.pagination.players": { one: "игрок", few: "игрока", many: "игроков", other: "игрока" },
  "leaderboard.users.hint": "Рейтинги, права администратора и удаление аккаунтов.",
  "leaderboard.users.pagination.users": { one: "пользователь", few: "пользователя", many: "пользователей", other: "пользователя" },
